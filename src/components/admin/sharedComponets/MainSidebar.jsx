...
import NSULogo from "../../../assets/images/NSU_logo_png.png";
...
const MainSidebar = () => {
    ...
    const isclickOutside = useOutsideClick(sidebarRef);

    useEffect(() => {
        //for hide and show sidemenu on click outside of side menu
        if (isclickOutside) {
    ...
    return (
        ...
        >
            ...
            <div className="sidebar">
                ...
                <div className="user-panel mt-3 pb-3 mb-3 d-flex align-center">
                    <div className="image">
                    ...
                    <div className="info">
                        <Link to="/">
                            <h5 className="text-dark ">NSU Admin</h5>
                        </Link>
                    </div>
                </div>
                {/* TODO:SidebarSearch Form */}
         ...
         with font-awesome or any other icon font library */}
                        ...
                        <li className="nav-item">
                            <NavLink to="/co" className="nav-link">
                        ...
                        <li className="nav-item">
                            <NavLink to="/studentCo" className="nav-link">
                                <i className="nav-icon fas fa-upload"></i>
                                <p>Upload Grade File</p>
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink to="/graph/cograph" className="nav-link">
                                <i className="nav-icon fas fa-chart-bar"></i>
                                <p>CO Graph</p>
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink to="/graph/pograph" className="nav-link">
                                <i className="nav-icon fas fa-chart-bar"></i>
                                <p>PO Graph</p>
                            </NavLink>
                        </li>
